...
def data_prex(path = '../PopulationData/townScale/'):
    population_json1 = pd.read_json(path+'seoul_town_scale_data_1.json')
    population_json2 = pd.read_json(path+'seoul_town_scale_data_2.json')
    population_json3 = pd.read_json(path+'seoul_town_scale_data_3.json')
